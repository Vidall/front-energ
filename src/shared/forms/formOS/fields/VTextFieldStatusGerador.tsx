...
import { IOs, IStatusGerador } from '../../../Service/api-JAVA/models/OrdemServico';
...
export const VTextFieldStatusGerador: React.FC<VTextFieldOsProps> = ({ name, control, errors, label, rules, editing = false, type, isMultiline=false }) => {
