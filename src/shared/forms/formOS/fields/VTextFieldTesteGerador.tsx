...
import { IOs, IStatusGerador, ITesteGerador } from '../../../Service/api-JAVA/models/OrdemServico';
...
interface VTextFieldOsProps {
  name: NestedKeyOf<ITesteGerador>;
  control: Control<ITesteGerador>;
  errors: FieldErrors<ITesteGerador>;
  label: string;
  rules?: any;
  editing?: boolean;
  type?: 'text' | 'number'
...
export const VTextFieldTesteGerador: React.FC<VTextFieldOsProps> = ({ name, control, errors, label, rules, editing = false, type, isMultiline=false }) => {
